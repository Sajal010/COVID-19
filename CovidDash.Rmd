  ...
  tryCatch(
    {
      ...
      dataList <- list(deaths = deaths, confirmed = confirmed, recovered = recovered, vaccinated = vaccinated, vaccineDose = vaccineDose)
      #save(dataList, file = "JHUData.RData")
      return(dataList)
    },
    error=function(e) {
      dataList <- readRDS(url("https://raw.githubusercontent.com/uchembaka/Data/main/JHUData.rds"))
      return(dataList)
    }
  )
}
...
oldData <- readRDS(url("https://raw.githubusercontent.com/uchembaka/Data/main/JHUData.rds"))

if(!pingr::is_online()) stop("No Internet Connection")

load(url("https://raw.githubusercontent.com/uchembaka/Data/main/JHUCountries.RData"))
...
renderPlotly({
  ...
  #fig <- plot_geo(mapDataCases, type='choropleth', locations=mapDataCases$iso3, z=mapDataCases$Deaths, text=mapDataCases$Country, colorscale="Inferno")
  fig <-fig %>% config(displayModeBar = F) %>% layout(height = 950, title = paste0("<br> <br>",input$map))%>% 
